            ...
            <div class="layui-row layui-col-md-offset1 strategy-inner" id="f-<s:property value="fid"/>">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block checkBox">
                        <input type="checkbox" title="购买" id="<s:property value="fid"/>" lay-filter="check">
                        <button id="<s:property value="fid"/>-btn" class="layui-btn layui-btn-danger del" style="height: 12%;line-height: 20px">删除</button>
                    </div>
                </div>
            </div>
